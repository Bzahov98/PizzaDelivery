...
alter table PIZZADELIVERY_ORDER add constraint FK_PIZZADELIVERY_ORDER_ON_EMPLOYER foreign key (EMPLOYER_ID) references PIZZADELIVERY_EMPLOYER(ID)^
...
create index IDX_PIZZADELIVERY_ORDER_ON_EMPLOYER on PIZZADELIVERY_ORDER (EMPLOYER_ID)^
